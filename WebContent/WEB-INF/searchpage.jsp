                ...
                <div class="sidebar">
                    ...
                    <div class="searchBasket">
                        <form class="search" action="search.do" method="POST">
	                        ...
	                        <input type="text" class="search" name="inputText" value="${inputTxt}" placeholder="I'm looking for...">
            ...
            <ul class="pagination">
		            <c:if test="${currentPage != 1}">
		                <li class="page-item"><a class="page-link"
		                    href="search.do?currentPage=${currentPage-1}&inputText=${inputTxt}">Previous</a>
		                </li>
		            </c:if>
		            ...
		            <c:forEach begin="1" end="${noOfPages}" var="i">
		                <c:choose>
		                    ...
		                    <c:otherwise>
		                        <li class="page-item"><a class="page-link"
		                            href="search.do?currentPage=${i}&inputText=${inputTxt}">${i}</a>
		                        </li>
		                    </c:otherwise>
		                </c:choose>
		            </c:forEach>
		            ...
		            <c:if test="${currentPage lt noOfPages}">
		                <li class="page-item"><a class="page-link"
		                    href="search.do?currentPage=${currentPage+1}&inputText=${inputTxt}">Next</a>
		                </li>
		            </c:if>
		        </ul>
        </div>
